  ...
  render() {
    ...
    return (
      (id, overview, styles, name, related)
        ? (
          <>
            <div className={this.state.lightMode ? style.lightMode : style.darkMode}>
              ...
              <div className={style.footer}>
                ...
                <div className={style.bottom}>
                  ...
                  <div className={style.bottomButtons}>
                    <button className={`${style.bottomButton} ${style.bottomButtonLight}`} onClick={this.lightMode}>LIGHT</button>
                    <button className={`${style.bottomButton} ${style.bottomButtonDark}`} onClick={this.darkMode}>DARK</button>
                  </div>
